 ...
 * MEMBUAT WALKTHROUGH
 *   MEMBUAT LAYOUT WALKTHROUGH 1
 *   MEMBUAT LAYOUT WALKTHROUGH 2
 *   MEMBUAT LAYOUT WALKTHROUGH 3
 * */
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btnNext.setText(getString(R.string.walkthrough_txt_start));
                btnSkip.setVisibility(View.GONE);
            } else {
                // still pages are left
                btnNext.setText(getString(R.string.walkthrough_txt_next));
